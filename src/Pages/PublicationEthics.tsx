  ...
  return (
    <>
      ...
      <div className="List">
        <ul>
          <li>
            يتعهد الباحث بأن البحث لم يسبق نشره، وأنه ليس مستلاً من رسالة
            ماجستير، أو أطروحة دكتوراه، أو كتاب منشور، ولم يقدم للنشر لجهات
            أخرى، وكذلك لن يقدم للنشر في جهة أخرى في الوقت نفسه لحين انتهاء
            إجراءات التحكيم، ويوافق الباحث على نقل حقوق النشر والتأليف إلى
            المجلة بعد إجازته للنشر بصورته النهائية.
          </li>
